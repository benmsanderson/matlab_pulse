...
minmat=[2010,2020,2040,2070,2100,2301,2764,emis_26(246),emis_26(256),0,-20,-10,-10,-10];
maxmat=[2010,2020,2040,2090,2300,2600,2764,emis_26(246),emis_26(256),0,20,10,10,10];
...
mc_ems=(rand(size(mdlpst,2),1)*emis_26(256));
...
save('emisopt4.mat','topt','topt_co','eopt','ceopt','topt_corr','ce_corr','targ')
